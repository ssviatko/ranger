...
lzss32_error_t lzss32_prepare_default_dictionary(lzss32_comp_ctx *ctx, uint8_t *a_buffer)
{
    ...
    return lzss32_prepare_dictionary(ctx, (const uint8_t *)default_seed, l_default_seed_len, a_buffer);
}
...
static void lzss32_match(lzss32_comp_ctx *ctx, uint8_t *a_in, uint32_t a_window_back, uint32_t a_window_ptr, uint32_t a_window_ptr_limit, uint16_t *a_match_back_ptr, uint8_t *a_match_len)
{
